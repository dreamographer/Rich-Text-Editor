...
import { LucidePaintBucket } from 'lucide-react';
...
interface SectionThreeBgProps extends VariantProps<typeof toggleVariants> {
	editor: Editor;
}

export const SectionThreeBg: React.FC<SectionThreeBgProps> = ({ editor, size, variant }) => {
		...
		<Popover>
			<PopoverTrigger asChild>
				<ToolbarButton
					...
					variant={variant}
				>
					<LucidePaintBucket className="size-5" style={{ color: selectedColor }} />
...
SectionThreeBg.displayName = 'SectionThree';

export default SectionThreeBg;
